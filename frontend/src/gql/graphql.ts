...
export type GetMeQuery = { __typename?: 'Query', getMe: { __typename?: 'AuntificateResponse', user?: { __typename?: 'UserResponse', id: string, tgId: number, firstName: string, lastName?: string | null, username?: string | null, isPremium?: boolean | null, languageCode?: string | null, allowsWriteToPm: boolean } | null } };
